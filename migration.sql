...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260504092641_AddAdministrationContent') THEN
    CREATE TABLE "PatchNotes" (
        ...
        "CreatedAtUtc" timestamp with time zone NOT NULL,
        "UpdatedAtUtc" timestamp with time zone NOT NULL,
        CONSTRAINT "PK_PatchNotes" PRIMARY KEY ("Id")
    );
    END IF;
END $EF$;
...
BEGIN
    ...
    CREATE TABLE "PlannedFeatures" (
        ...
        "CreatedAtUtc" timestamp with time zone NOT NULL,
        "UpdatedAtUtc" timestamp with time zone NOT NULL,
        CONSTRAINT "PK_PlannedFeatures" PRIMARY KEY ("Id")
    );
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260504092641_AddAdministrationContent') THEN
    CREATE TABLE "PatchNoteEntries" (
        "Id" uuid NOT NULL,
        "PatchNoteId" uuid NOT NULL,
        "TextFr" text NOT NULL,
        "TextEn" text NOT NULL,
        "DisplayOrder" integer NOT NULL,
        CONSTRAINT "PK_PatchNoteEntries" PRIMARY KEY ("Id"),
        CONSTRAINT "FK_PatchNoteEntries_PatchNotes_PatchNoteId" FOREIGN KEY ("PatchNoteId") REFERENCES "PatchNotes" ("Id") ON DELETE CASCADE
    );
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260504092641_AddAdministrationContent') THEN
    CREATE INDEX "IX_PatchNoteEntries_PatchNoteId" ON "PatchNoteEntries" ("PatchNoteId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260504092641_AddAdministrationContent') THEN
    CREATE INDEX "IX_PatchNoteEntries_PatchNoteId_DisplayOrder" ON "PatchNoteEntries" ("PatchNoteId", "DisplayOrder");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260504092641_AddAdministrationContent') THEN
    CREATE INDEX "IX_PatchNotes_IsPublished_DisplayOrder_PublishedAtUtc" ON "PatchNotes" ("IsPublished", "DisplayOrder", "PublishedAtUtc");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260504092641_AddAdministrationContent') THEN
    CREATE UNIQUE INDEX "IX_PatchNotes_Version" ON "PatchNotes" ("Version");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260504092641_AddAdministrationContent') THEN
    CREATE INDEX "IX_PlannedFeatures_IsActive_DisplayOrder" ON "PlannedFeatures" ("IsActive", "DisplayOrder");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260504092641_AddAdministrationContent') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20260504092641_AddAdministrationContent', '10.0.5');
    END IF;
END $EF$;
COMMIT;
